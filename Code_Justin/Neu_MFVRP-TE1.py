...
for pref_share in np.arange(0, 1.05, 0.05):
    ...
    for run in range(10):  # Wiederholungen
        ...
        results.append({
            ...
            "Ø Gesamtemissionen": z_emis
        })

# Ergebnisse aggregieren
df = pd.DataFrame(results)
means = df.groupby("Anteil_emissionsorientiert").mean().reset_index()
means.to_excel("MFVRP-TE2.xlsx", index=False)
print("\n✅ Ergebnisse gespeichert in 'MFVRP-TE2.xlsx'")
...
plt.tight_layout()
plt.suptitle("Einfluss emissionsorientierter Kunden – Minimierung Emissionen", fontsize=14, y=1.05)
plt.savefig("MFVRP-TE2.png", bbox_inches="tight", dpi=300)
print("📊 Plot gespeichert als 'MFVRP-TE2.png'")